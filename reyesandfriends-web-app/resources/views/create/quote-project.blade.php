...
@section('content')
	<section class="relative isolate py-16 overflow-hidden">
		<div class="container mx-auto px-6">
			...
			<div class="relative z-20 max-w-screen-xl max-md:max-w-xl mx-auto bg-black py-8 px-8 md:px-12 rounded-lg shadow-lg" data-aos="zoom-in" data-aos-duration="1200">
