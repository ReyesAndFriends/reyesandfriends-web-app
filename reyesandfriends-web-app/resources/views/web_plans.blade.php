    ...
    <section class="relative w-full h-[70vh] flex items-center justify-center bg-cover bg-center overflow-hidden">
        ...
        <div class="relative z-10 container mx-auto flex flex-col md:flex-row items-center h-full px-6 gap-8">
            ...
            <div class="w-full md:w-1/2 text-white space-y-6">
                ...
                <p class="text-2xl md:text-3xl text-red-600 mb-6 drop-shadow font-medium">Personalizable y adaptable a tus necesidades</p>
                <p class="text-lg md:text-xl text-gray-200 leading-relaxed font-medium">¡Lleva tu presencia online al siguiente nivel con nuestros planes web por suscripción mensual! Personaliza el diseño, agrega contenido nuevo cada mes y olvídate de lo técnico: nosotros nos encargamos del hosting, mantenimiento y soporte. Tú solo enfócate en crecer, nosotros hacemos el resto.</p>
            </div>
        </div>
    </section>
        ...
        <div class="container mx-auto px-6">
            ...
            <div class="space-y-12">
                @foreach($webPlans as $webPlan)
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12 p-12 items-start">
