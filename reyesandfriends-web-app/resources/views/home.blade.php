    ...
    <section class="relative w-full min-h-[90vh] md:min-h-[70vh] flex items-center justify-center bg-cover bg-center overflow-hidden py-12 md:py-0">
            ...
            <div class="relative z-10 container mx-auto flex flex-col md:flex-row items-center h-full px-6 gap-8 md:gap-10">
                <div class="w-full md:w-1/2 text-white space-y-6" data-aos="fade-right" data-aos-duration="1200">
                    <h1 class="text-4xl sm:text-5xl md:text-6xl font-bold mb-4 drop-shadow-lg" data-aos="fade-down" data-aos-delay="200" data-aos-easing="ease-in-out" data-aos-duration="1200">Desarrollamos</h1>
                ...
                <div class="w-full md:w-1/2 flex justify-center" data-aos="fade-left" data-aos-duration="1200">
                    <img src="{{ asset('img/home/desktop.png') }}" alt="Solución digital" class="w-auto h-[240px] sm:h-[300px] md:h-auto md:w-3/4 max-w-full drop-shadow-xl pointer-events-none object-contain" />
                </div>
            </div>
    </section>
    ...
    <section class="py-16">
        <div class="container mx-auto px-6">
            ...
            <div class="grid grid-cols-1 gap-8 items-center justify-items-center">
                <div class="flex flex-col justify-center items-center text-center mx-auto" data-aos="fade-right" data-aos-delay="200" data-aos-once="true">
                    <p class="text-lg text-gray-300 leading-relaxed max-w-3xl" data-aos="fade-up" data-aos-delay="200" data-aos-once="true">
                     ...
                     <img src="{{ asset('img/home/equipo-robot.png') }}" alt="Ilustración de equipo de trabajo" class="w-128 h-auto pointer-events-none robot-fade-mask" />
                </div>
            </div>
